...
const Sales: React.FC = () => {
  ...
  const { searchValue: oppSearch, bindInput: oppSearchInputProps } = useDebouncedSearchInput();
  ...
  }, [activeTab, oppSearch, stageFilter, orderStatusFilter, pageSize, oppSortBy, oppSortOrder, orderSortBy, orderSortOrder]);
